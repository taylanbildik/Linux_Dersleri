...
Sonuç Olarak
-
**Linux** bir işletim sistemi değil **çekirdektir(kernel)** **GNU/Linux** bütünü bir **işletim sistemidir**. Ancak genellikle söylenmesi uzun veya zor geldiği için zamanla sadece **Linux** olarak geçmeye başlamıştır. Ben de yazımda **GNU/Linu**x yerine **Linux** kullanıyor olacağım. Ancak emin olun **çekirdekten**(**kernel**) yani **Linux**'tan bahsettiğimde ve **GNU/Linux**(**işletim sistemi**)'tan bahsettiğimde hangisini kastettiğimi anlıyor olacaksınız.
